# PCM-Connect Python — Documentation

This document combines the architecture/design and the team quickstart for the
Python (FastAPI) Data Source Adapter implementation.

- [Part 1 — Architecture & Design](#part-1--architecture--design)
- [Part 2 — Team Quickstart](#part-2--team-quickstart)
